...
| Implement User model with bcrypt password hashing and role enum | 0.5 day | Backend |
| Build authentication endpoints (admin login, logout, /me) | 1 day | Backend |
| Build face login endpoint for students and teachers | 0.5 day | Backend |
| Implement JWT protect middleware and role-based allowRoles middleware | 0.5 day | Backend |
| Build User management endpoints (CRUD with role-based access control) | 1 day | Backend |
| Implement face detection utilities (model loading, descriptor extraction, face comparison) | 1 day | Backend |
| Build face enrollment endpoint (extract and store face descriptor from base64 image) | 0.5 day | Backend |
| Build Kiosk controller (get descriptors, record time-in/time-out with server-side re-verification) | 1 day | Backend |
| Build Attendance Logs endpoints with filtering, pagination, and summary statistics | 1 day | Backend |
...
| Implement face-api model loading and face descriptor extraction on the frontend | 1 day | Frontend |
